...
Is there a correlation CMS platform and website carbon measurement in Local Government?
...
First we need to get a dataset with all the data from council-website-emissions + an extra column for the CMS, looked up from council-cms.
